                ...
                <tr>
                    ...
                    <td>
                        <input type='button' class="coolbg np"
                               onClick="location='${pageContext.request.contextPath}/mybaoxiao-add.jsp';" value='添加报销'/>
                    </td>
                </tr>
            </table>
        </td>
...
<form name="form2">
    ...
    <table width="98%" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
        ...
        <c:forEach items="${page.list}" var="bx" varStatus="i">
            <tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';"
                ...
                <td align="center"><a href=''><u>
                    <fmt:formatDate value="${bx.bxtime}" pattern="yyyy-MM-dd"></fmt:formatDate> </u></a></td>
                <td>${bx.bxremark}</td>
