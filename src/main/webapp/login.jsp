...
<HEAD>
    ...
    <script type="text/javascript">
        ...
        $.ajax({
            type:"GET",
            url:"${pageContext.request.contextPath}/emp/yanz",
            success:function (msg) {
                var td="<INPUT id=\"yan\" style=\"width: 75px\" class=regtxt title=请填写验证码 maxLength=50\n" +
                    "\t\t\t\t\t\t\t\t\t\t\t\t  name=\"code\" size=16 value="+msg.validateCode+"  name=path>";
                $("#image").before(td);
            }
        })
    </script>
                                ...
                                <TABLE id=table2 cellSpacing=1 cellPadding=0 width="100%"
                                    ...
                                    <TR>
                                        ...
                                        <TD><INPUT class=regtxt title=请填写用户名 maxLength=16
                                                   size=16 name=username value=12 id=username></TD>
                                    </TR>
                                    <TR>
                                        <TD align=middle width=81><FONT color=#ffffff>密&nbsp;
                                            码：</FONT></TD>
                                        <TD><INPUT class=regtxt title=请填写密码 type=password
                                                   maxLength=16 size=16 value=34 name=password id=pass></TD>
                                    </TR>
                                    <TR>
                                        ...
                                        <TD><%--<INPUT class=regtxt title=请填写验证码 maxLength=50
                                                   size=16  name=code>--%>
                                            <img id="image"
                                                 src="${pageContext.request.contextPath}/code/getCode?time="<%=new Date()%> >
                                    </TR>
                                    </TBODY>
                                </TABLE>
                            </TD>
